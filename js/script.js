...
function showCard(data, perso) {
    ...
    card +=
        "<div class='intelligence' style='width:" +
    ...
    card +=
        "<div class='strength' style='width:" +
    ...
    card +=
        "<div class='duralibity' style='width:" +
...
function getJSON(url, callback, perso) {
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            console.warn("Problema com a API: " + xhr.status);
        }
    };
    xhr.send();
}
